---
name: third-party-flight505-technical-docs-vitepress-config-creator
description: |
  Create vitepress config creator operations. Auto-activating skill for Technical Documentation.
