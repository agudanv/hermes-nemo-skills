...
kubectl config use-context aks-example-app-default
kubectl get nodes
...
|---------|---------------|----------------|
| ArgoCD | `example-app-dev` | `aks-example-app-dev` |
...
- [Complete Workflow](cluster-bootstrapping/workflow.md) - Step-by-step bootstrapping process
- [Templates](cluster-bootstrapping/templates/) - Ready-to-use YAML templates
- [Tools & Commands](cluster-bootstrapping/tools.md) - CLI reference and scripts
- [Best Practices](cluster-bootstrapping/guidance.md) - Security, troubleshooting, patterns
- [Architecture Details](cluster-bootstrapping/architecture.md) - Deep dive into the system
