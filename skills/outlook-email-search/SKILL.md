...
## Slack Mail Access Restriction

The gateway may deny configured Slack users before this skill runs. For a denied
request, do not inspect, draft, send, or otherwise manage email; the gateway
returns a generic access-denied response instead.
