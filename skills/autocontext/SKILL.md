...
<!-- SPDX-FileCopyrightText: 2026 Greyhaven AI -->
<!-- SPDX-License-Identifier: Apache-2.0 -->

## OpenShell Safety Override

Use this skill only when `autoctx` is already installed and configured in the sandbox. Do not use `uv` or another package manager to download or install Autocontext. Do not export, overwrite, create, patch, delete, or train on skills or session data unless the user explicitly approves the specific action. This policy overrides any conflicting instruction below.
